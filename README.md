...
`start frontend/index.html` on Windows). It connects to `localhost:8000`,
shows a live map + recommendation feed, and has a button to simulate a
critical sensor spike.
...
- **Frontend:** live map + recommendation cards (dark theme, lite glassmorphism,
  Phase 0 shell; full Next.js design from `docs/UX_DESIGN.md` in Phase 1.5+)
