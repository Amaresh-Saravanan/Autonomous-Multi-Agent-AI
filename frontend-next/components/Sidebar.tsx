...
export default function Sidebar() {
  ...
  return (
    <nav
      className={`flex shrink-0 flex-col border-r border-console-outline-variant/20 bg-console-surface/60 backdrop-blur-xl transition-[width] duration-200 ${
        collapsed ? "w-14" : "w-44"
      }`}
    >
      ...
      <button
        ...
        className="flex items-center justify-center gap-sm border-t border-console-outline-variant/20 p-sm text-console-on-surface-variant hover:bg-console-surface-container/40 hover:text-console-on-surface"
      >
        {collapsed ? (
