...
const features = [
  {
    number: "01",
    title: "Incident Clustering & Detection",
    description: "Clusters related sensor, satellite, weather, and citizen reports into actionable incidents.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Multi-Agent Recommendation Engine",
    description: "Coordinates specialized agents to generate explainable response recommendations.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Route Optimization",
    description: "Identifies efficient routes for response teams as incident conditions evolve.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Alert Deduplication",
    description: "Reduces repeated signals so operators can focus on verified, high-priority incidents.",
    visual: "security",
  },
  {
    number: "05",
    title: "Role-Based Access Control",
    description: "Supports controlled access to response information and operator actions.",
    visual: "security",
  },
  {
    number: "06",
    title: "Real-Time Situational Awareness",
    description: "Presents a shared, live operational picture for coordinated disaster management.",
    visual: "collab",
  },
];
